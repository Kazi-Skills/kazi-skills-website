...
export default function Categories() {
    return (
        <section id="categories" className="py-24 lg:py-40 bg-gray-50 scroll-mt-20 border-y border-gray-100">
            <div className="max-w-7xl mx-auto px-6 lg:px-12">
                <div className="text-center mb-24">
                    ...
                    <p className="text-gray-500 text-lg lg:text-xl max-w-2xl mx-auto font-medium leading-relaxed">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-12">
                    {cats.map((cat, i) => (
                        <motion.div 
                            ...
                            key={i} 
                            className="group relative rounded-[40px] p-10 bg-white border border-gray-100 hover:border-purple-200 transition-all duration-500 hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] hover:-translate-y-2 overflow-hidden"
                        >
                            <div className={`w-16 h-16 rounded-[20px] bg-linear-to-br ${cat.bg} flex items-center justify-center text-3xl mb-8 shadow-lg group-hover:scale-110 transition-transform duration-500 mx-auto`}>
                                {cat.icon}
                            </div>
                            
                            <h3 className="text-gray-900 font-black text-2xl mb-3 tracking-tight text-center" style={{ fontFamily: 'Syne, sans-serif' }}>
                                {cat.name}
                            </h3>
                    ...
                    <motion.div 
                        ...
                        className="group relative rounded-[40px] p-10 bg-gray-900 overflow-hidden hover:shadow-[0_30px_60px_-15px_rgba(124,58,237,0.4)] transition-all duration-500 hover:-translate-y-2"
                    >
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-between">
                            <div>
                                <h3 className="text-white font-black text-3xl mb-4 tracking-tight leading-tight" style={{ fontFamily: 'Syne, sans-serif' }}>
